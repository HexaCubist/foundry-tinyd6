...
export default class DieRoller extends FormApplication {
  ...
  activateListeners(html) {
    ...
    html
      ...
      .on("click", this._setMarksmanTrait.bind(this));
    html
      .find(".toggle-marksman")
      .on("change", this._setMarksmanTrait.bind(this));
    ...
    elmnt.on("mousedown", (e) => {
      ...
      dieRoller[0].style = dieRoller[0].style ?? {
        top: "" + math.round(startPosY) + "px",
        left: "" + Math.round(startPosX) + "px",
      };
